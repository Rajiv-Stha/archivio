...
<div class="modal fade dialogbox" id="DialogFollowerButton" data-bs-backdrop="static" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content text-center">
            ...
            <div class="modal-body" style="background: #fff!important;">
                <h3 class="text-dark">mirko_castagno <br> <span class="text-muted">vuole iniziare a seguirti.</span></h3>
                <h3>Accettare la richiesta</h3>
            </div>
