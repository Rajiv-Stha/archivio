...
<body>
    ...
    <!-- * Headerstyle="height: 100vh!important;" -->
    ...
    <div id="appCapsule" class="bg-white" style="padding: 0px!important;"> 
        <div class="section pe-0 ps-0 wh-100">
            ...
            <form>
                ...
                <input type="file" id="croppie-input" class="invisible" accept="image/*">
                <div class="" style="height: 100vh!important; background: gray!important; margin-top: -80px!important;">


                    
                        <div id="croppie-demo" style="height: 100vh!important;"></div>
                    ...
                    <div class="fab-button animate bottom-center dropdown"  style="position: absolute; bottom: 15%!important; z-index: 999999;" id="capture">
                        <div class="fab" style="background: #fff!important;">
