...
$user_id_get = (float) $_REQUEST['uid'];
...
if ($l_number >0) {
    ...
    $sql2="SELECT  DISTINCT spotted_request_to_user_id , spotted_request_post_id  from spotted_request where spotted_request_user_id = '$user_id_get' AND spotted_request_confirmed = 1 AND spotted_request_status = 1;"; //confermate
