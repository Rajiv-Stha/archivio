...
if ($l_number >0) {
    ...
    $sql1="SELECT * from followers where follow_user_id = '$user_id_get' AND follower_type = 'user' AND follower_status = 1 ORDER BY follower_timestamp DESC;"; //confermate
    //echo $sql1;
...
?>
    <li>
        <div class="item">
            <img src="<?php echo $path_url; ?><?php echo $user_img; ?>" alt="image" class="image">
            <div class="in">
